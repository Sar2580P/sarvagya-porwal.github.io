...
* **Second Term (Exploration):**  acts as an entropy-regularized exploration bonus, pushing the policy *&pi;* towards actions with higher estimated Q-values, even if they deviate slightly from the replay-dataset.
